...
public abstract class PositionHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(PositionHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_struct_tc(fr.upem.robot.PositionHelper.id(),"Position",new org.omg.CORBA.StructMember[]{new org.omg.CORBA.StructMember("posX", org.omg.CORBA.ORB.init().get_primitive_tc(org.omg.CORBA.TCKind.from_int(3)), null),new org.omg.CORBA.StructMember("posY", org.omg.CORBA.ORB.init().get_primitive_tc(org.omg.CORBA.TCKind.from_int(3)), null)});
				}
			}
		}
		return _type;
	...
	public static void insert (final org.omg.CORBA.Any any, final fr.upem.robot.Position s)
	{
		any.type(type());
	...
	public static fr.upem.robot.Position read (final org.omg.CORBA.portable.InputStream in)
	{
	...
	public static void write (final org.omg.CORBA.portable.OutputStream out, final fr.upem.robot.Position s)
	{
