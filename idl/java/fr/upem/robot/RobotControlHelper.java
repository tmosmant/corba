...
public abstract class RobotControlHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(RobotControlHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_interface_tc("IDL:fr/upem/robot/RobotControl:1.0", "RobotControl");
				}
			}
		}
		return _type;
	...
	public static void insert (final org.omg.CORBA.Any any, final fr.upem.robot.RobotControl s)
	{
			any.insert_Object(s);
	}
	...
	public static void write(final org.omg.CORBA.portable.OutputStream _out, final fr.upem.robot.RobotControl s)
	{
		_out.write_Object(s);
	}
	public static fr.upem.robot.RobotControl narrow(final org.omg.CORBA.Object obj)
	{
		if (obj == null)
		{
			return null;
	...
	public static fr.upem.robot.RobotControl unchecked_narrow(final org.omg.CORBA.Object obj)
	{
		if (obj == null)
		{
			return null;
