...
public abstract class NotStartedHelper {
			...
			synchronized (NotStartedHelper.class) {
				if (_type == null) {
					_type = org.omg.CORBA.ORB
							.init()
							.create_exception_tc(fr.upem.robot.NotStartedHelper.id(), "NotStarted",
	...
	public static void insert(final org.omg.CORBA.Any any,
			final fr.upem.robot.NotStarted s) {
		any.type(type());
	...
	public static fr.upem.robot.NotStarted read(
		...
		java.lang.String x0;
		x0 = in.read_string();
		final fr.upem.robot.NotStarted result = new fr.upem.robot.NotStarted(
				id, x0);
		return result;
	}
	...
	public static void write(final org.omg.CORBA.portable.OutputStream out,
			final fr.upem.robot.NotStarted s) {
		out.write_string(id());
		java.lang.String tmpResult2 = s.message;
