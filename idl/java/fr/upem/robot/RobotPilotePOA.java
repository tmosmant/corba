...
public abstract class RobotPilotePOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, fr.upem.robot.RobotPiloteOperations
{
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			try
			{
				fr.upem.robot.Position _arg0=fr.upem.robot.PositionHelper.read(_input);
