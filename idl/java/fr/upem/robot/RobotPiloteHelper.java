...
public abstract class RobotPiloteHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(RobotPiloteHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_interface_tc("IDL:fr/upem/robot/RobotPilote:1.0", "RobotPilote");
				}
			}
		}
		return _type;
	...
	public static void insert (final org.omg.CORBA.Any any, final fr.upem.robot.RobotPilote s)
	{
			any.insert_Object(s);
	}
	...
	public static void write(final org.omg.CORBA.portable.OutputStream _out, final fr.upem.robot.RobotPilote s)
	{
		_out.write_Object(s);
	}
	public static fr.upem.robot.RobotPilote narrow(final org.omg.CORBA.Object obj)
	{
		if (obj == null)
		{
			return null;
	...
	public static fr.upem.robot.RobotPilote unchecked_narrow(final org.omg.CORBA.Object obj)
	{
		if (obj == null)
		{
			return null;
